...
let
  sources = {
    ...
    "minipass-2.8.4" = {
      ...
      version = "2.8.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/minipass/-/minipass-2.8.4.tgz";
        sha512 = "i97pKD0f0eZLlhcTTSa6b6QlxCD7cvh8t/5MyR/pqchD5GPAeDaUrXQCoYA+W/VmmCgWvS/ADbfW3FUc+iT51Q==";
      };
    };
    "minizlib-1.2.2" = {
      name = "minizlib";
